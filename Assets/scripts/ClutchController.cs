...
public class ClutchController : MonoBehaviour
{
    ...
    [Tooltip("If enabled, clutch behaves like binary switch (useful for keyboard testing)")]
    [SerializeField] private bool keyboardAssistMode = false;
    ...
    private void Update()
    {
        ...
        if (keyboardAssistMode)
        {
            // превращаем клавиатурный ад в что-то управляемое
            rawValue = rawValue > 0.5f ? 1f : 0f;
        }
